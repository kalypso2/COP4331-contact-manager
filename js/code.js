			...
			if(this.status == 200){
                ...
                if (jsonResponce.error) {
                    if (jsonResponce.error === "Login already exists") {
                        console.log("Login exists already");
                        document.getElementById("signupResult").innerHTML = "Login already exists";
...
function edit_row(id) {
    ...
    firstNameI.innerHTML = "<input type='text' class='bg-gray-200 rounded-md w-full' id='namef_text" + id + "' value='" + namef_data + "'>";
    lastNameI.innerHTML = "<input type='text' class='bg-gray-200 rounded-md w-full' id='namel_text" + id + "' value='" + namel_data + "'>";
    email.innerHTML = "<input type='text' class='bg-gray-200 rounded-md w-full' id='email_text" + id + "' value='" + email_data + "'>";
    phone.innerHTML = "<input type='text' class='bg-gray-200 rounded-md w-full' id='phone_text" + id + "' value='" + phone_data + "'>"
}
...
function doAllContacts()
{
    ...
    loadAllContacts(); // Reload the contacts
}
